#The code calcultes the electrostatic and vdw interactions of a ligand with residues whithin 5 angstrom. If you want to change this cutoff value, do it in line 19 (ligand_id<:5). The trajectory must have box information not removed.
...
cpptraj_output=$(cpptraj -p $topology_file -c $reference --resmask ":$ligand_id<:5")
